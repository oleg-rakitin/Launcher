...
public class PostgreSQLCoreProvider extends AuthCoreProvider implements AuthSupportHardware {
    private transient final Logger logger = LogManager.getLogger();
    public PostgreSQLSourceConfig postgreSQLHolder;
    ...
    public void init(LaunchServer server) {
        if (postgreSQLHolder == null) logger.error("mySQLHolder cannot be null");
    ...
    public UserHardware getHardwareInfoByPublicKey(byte[] publicKey) {
        try (Connection connection = postgreSQLHolder.getConnection()) {
