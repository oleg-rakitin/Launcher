...
public final class VerifyHelper {
    ...
    public static final Pattern USERNAME_PATTERN = Pattern.compile(Boolean.parseBoolean(System.getProperty("username.russian", "true")) ? "[a-zA-Zа-яА-Я0-9_.\\-]{1,25}" : "[a-zA-Z0-9-_\\\\.]{1,25}");
